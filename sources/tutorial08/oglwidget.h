...
private:
    ...
    std::unique_ptr<QOpenGLShaderProgram> cubeShader = nullptr;
    std::unique_ptr<QOpenGLVertexArrayObject> cubeVao = nullptr;
    std::unique_ptr<QOpenGLBuffer> cubeVBuffer = nullptr;
    std::unique_ptr<QOpenGLBuffer> cubeIBuffer = nullptr;
